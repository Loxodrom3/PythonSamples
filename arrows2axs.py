...
# Scatter Plot 1
axs[0,0].plot((0,0),(yLimits1), color="black", lw=0.75)
axs[0,0].plot((xLimits1),(0,0), color="black", lw=0.75)
axs[0,0].set_facecolor(color= Gry)
axs[0,0].scatter(xRAW1, yRAW1, color =LBlu)
axs[0,0].scatter(xRPC1, yRPC1, color =DGrn)
axs[0,0].set_title(image1Name, fontsize =8)
# Draw arrows
for i in range(len(xRAW1)):
    axs[0,0].arrow(xRAW1[i], yRAW1[i], (xRPC1[i]-xRAW1[i]), (yRPC1[i]-yRAW1[i]),color = "blue",
    head_width=0.7, lw=0.2, shape="full", length_includes_head=True )

axs[0,0].grid()
axs[0,0].set_aspect('equal', 'box')
axs[0,0].set(xlim=(xLimits1), ylim=(yLimits1))
